...
import br.com.nicolasdimer.projetodeufome.security.TokenUtil;
...
public class ClienteService {
    ...
    public Token gerarToken(@Valid ClienteDto cliente) {
		Cliente user = repository.findBynomeOrEmail(cliente.getNome(), cliente.getEmail());
		if (user != null) {
			Boolean valid = passwordEncoder.matches(cliente.getSenha(), user.getSenha());
			if (valid) {
